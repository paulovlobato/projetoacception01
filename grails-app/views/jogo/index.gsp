		...
		<div id="list-jogo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="plataforma" title="${message(code: 'jogo.plataforma.label', default: 'Plataforma')}" />
				...
				<g:each in="${jogoInstanceList}" status="i" var="jogoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${jogoInstance.id}">${fieldValue(bean: jogoInstance, field: "nome")}</g:link></td>
					
						<td>${fieldValue(bean: jogoInstance, field: "plataforma")}</td>
